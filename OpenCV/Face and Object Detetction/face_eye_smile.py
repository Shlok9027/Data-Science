...
eye_cascade = cv2.CascadeClassifier("OpenCV\Face and Object Detetction\haarcascade_eye.xml")
smile_cascade = cv2.CascadeClassifier("OpenCV\Face and Object Detetction\haarcascade_smile.xml")
